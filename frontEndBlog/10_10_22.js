document.write(
    ...
    \
        <p>\
            ...
            to a page with a game board where you can actually play "tetris" (apperently I\'m not allowed to call it tetris &#128580;) and then there\'s also some \
            back end stuff done that I don\'t really know anything about. It\'s not perfect but it is a working demo :) \
            <br> <br>\
            Next up we will have a meeting within the front end group to plan and decide what we want to accomplish in sprint 2. <br>\
